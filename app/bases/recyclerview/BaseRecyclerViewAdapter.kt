package com.pettranslator.cattranslator.catsounds.bases.recyclerview
...
abstract class BaseRecyclerViewAdapter<T, V : RecyclerView.ViewHolder>(
    ...
    protected  var itemClickListener: ((view: View, item: T, position: Int) -> Unit)? = null
    ...
    fun registerItemClickListener(onItemClickListener: ((view: View, item: T, position: Int) -> Unit)) {
